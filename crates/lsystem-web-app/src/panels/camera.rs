...
use leptos::prelude::*;
use lsystem_app_model::CAMERA_ROTATION_STEP_DEGREES;
            ...
            <Show when=move || is_3d.get()>
                ...
                <div class="btn-row">
                    <button
                        type="button"
                        disabled=disabled
                        on:click=move |_| camera_orbit.run((-CAMERA_ROTATION_STEP_DEGREES, 0.0))
                    >"◀"</button>
                    <button
                        type="button"
                        disabled=disabled
                    ...
                    <button
                        type="button"
                        disabled=disabled
                        on:click=move |_| camera_orbit.run((0.0, CAMERA_ROTATION_STEP_DEGREES))
                    >"▲"</button>
                    <button
                        type="button"
                        disabled=disabled
                ...
                <div class="btn-row">
                    <button
                        type="button"
                        disabled=disabled
                        on:click=move |_| camera_roll.run(-CAMERA_ROTATION_STEP_DEGREES)
                    >"↺"</button>
                    <button
                        type="button"
                        disabled=disabled
