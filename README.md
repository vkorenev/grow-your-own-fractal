...
**Reset** restores the bundled preset default. While a draft differs from the
last-applied config, iteration/angle/export controls are hidden until the draft
